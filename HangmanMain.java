 ...
 *   With minuscule modifications by Abraham Martinez.
 */
...
public class HangmanMain  {
    ...
    // Harder list additional details for debugger.
    private static void hardDetails(HangmanManager hangman, TreeMap<String, Integer> r) {
    	String debug = "\nDEBUGGING: ";
    	System.out.print(debug + "Picking hardest list.");
    	System.out.print(debug + "New pattern is: " + hangman.getPattern() + ". ");
    	int numWordInFamily = r.get(hangman.getPattern());
    	System.out.println("New family has " + numWordInFamily + " words.\n");
    }
